...
require (
	...
	github.com/conduitio/conduit-connector-protocol v0.6.1-0.20240715153818-b1faf91cf8f1
	github.com/conduitio/conduit-connector-sdk v0.9.2-0.20240715153923-e786b5b9e4e7
