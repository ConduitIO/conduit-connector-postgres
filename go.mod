...
require (
	...
	github.com/conduitio/conduit-connector-protocol v0.6.1-0.20240715152621-e5d6fbcbbf82
	github.com/conduitio/conduit-connector-sdk v0.9.2-0.20240715152657-8a5923d907e2
